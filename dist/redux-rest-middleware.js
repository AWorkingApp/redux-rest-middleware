...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("redux-rest-middleware", [], factory);
	else if(typeof exports === 'object')
		exports["redux-rest-middleware"] = factory();
	else
		root["redux-rest-middleware"] = factory();
...
function requestSuccessReducer(state, action) {
  var dataIdx;
  var resultState = state.set('loading', false).setIn([action.resource, 'loading'], false);

  if (action.payload.id) {
    dataIdx = resultState.getIn([action.resource, 'data']).findIndex(function (d) {
      return "".concat(d.get('id')) === "".concat(action.payload.id);
    });
  } else if (action.id) {
    dataIdx = resultState.getIn([action.resource, 'data']).findIndex(function (d) {
      return d.get('id') === action.id;
    });
  }
  ...
  switch (action.method) {
    case _constants__WEBPACK_IMPORTED_MODULE_2__["METHODS"].GET:
      if (action.id) {
        return resultState.setIn([action.resource, 'detail'], Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(action.payload));
      }

      return resultState.setIn([action.resource, 'data'], Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(action.payload));

    case _constants__WEBPACK_IMPORTED_MODULE_2__["METHODS"].POST:
      return resultState.updateIn([action.resource, 'data'], function (data) {
        return data.push(Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(action.payload));
      });

    case _constants__WEBPACK_IMPORTED_MODULE_2__["METHODS"].PUT:
      // if current detail is loaded, update detail as well
      if (resultState.getIn([action.resource, 'detail', 'id']) === action.payload.id || typeof resultState.getIn([action.resource, 'detail', 'id']) === 'undefined') {
        resultState = resultState.setIn([action.resource, 'detail'], Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(action.payload));
      }

      if (dataIdx > -1) {
        return resultState.setIn([action.resource, 'data', dataIdx], Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(action.payload));
      } else {
        return resultState.updateIn([action.resource, 'data'], function (data) {
          return data.unshift(Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(action.payload));
        });
      }

    case _constants__WEBPACK_IMPORTED_MODULE_2__["METHODS"].DELETE:
      if (dataIdx > -1) {
        return resultState.deleteIn([action.resource, 'data', dataIdx]).deleteIn([action.resource, 'detail']);
      }
...
function resources() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(_objectSpread({
    loading: false
  }, Object(_resources__WEBPACK_IMPORTED_MODULE_1__["getInitialReducerState"])()));
  var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

  switch (action.type) {
    case _constants__WEBPACK_IMPORTED_MODULE_2__["GET_RESOURCES"]:
      return state.set('loading', true).setIn([action.resource, 'loading'], true);
    ...
    case _constants__WEBPACK_IMPORTED_MODULE_2__["DELETE_RESOURCE"]:
      return state.set('loading', true).setIn([action.resource, 'loading'], true).setIn([action.resource, 'detail'], Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])({}));
    ...
    case _constants__WEBPACK_IMPORTED_MODULE_2__["CLEAR_RESOURCE_DATA"]:
      return state.setIn([action.resource, 'data'], Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])([]));

    case _constants__WEBPACK_IMPORTED_MODULE_2__["CLEAR_RESOURCE_DETAIL"]:
      return state.setIn([action.resource, 'detail'], Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])({}));
    // return to initial state

    case _constants__WEBPACK_IMPORTED_MODULE_2__["CLEAR_ALL"]:
      return Object(immutable__WEBPACK_IMPORTED_MODULE_0__["fromJS"])(_objectSpread({
        loading: false
      }, Object(_resources__WEBPACK_IMPORTED_MODULE_1__["getInitialReducerState"])()));
